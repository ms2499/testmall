...
@RequestMapping("/com")//聲明請求的路徑和請求方法(使用此註解來暴露REST API端點)
...
public class ComTagsController {
    ...
    @ResponseBody
    public String deleteCommodityTag(@RequestBody(required = false) List<String> subTags, List<String> mainTags){
        return comTagsService.deleteCommodityTag(subTags, mainTags);
    }
